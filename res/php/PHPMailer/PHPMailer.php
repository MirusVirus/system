...
// namespace PHPMailer\PHPMailer; JAN COMMENTED THIS OUT
...
class PHPMailer
{
    ...
    public function __construct($exceptions = null)
    {
		...
		/*** JAN PUT THE FOLLOWING IN THE CONSTRUCTOR IN ORDER TO PULL DATA FROM config.php: ***/
		$this->CharSet = 'UTF-8';
		$this->SMTPAuth = true; 
		$this->SMTPDebug = 0;			// 1-4
		$this->isSMTP();
		...
		$this->SMTPSecure = 'TLS';
		$this->Port = 25;
		$this->addReplyTo(EMAIL_ADDRESS);
		$this->setFrom(EMAIL_ADDRESS, 'Kranich Automobile Admin');
		$this->isHTML(true);	
    }
